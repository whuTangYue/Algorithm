...
/******************************************************************************
 * Compilation: javac Bernoulli.java Execution: java Bernoulli n trials
 * Dependencies: StdDraw.java StdRandom.java Gaussian.java StdStats.java
 * 
 * Each experiment consists of flipping n fair coins trials times. Plots a
 * histogram of the number of times i of the n coins are heads.
 *
...
public class Bernoulli {
	...
	public static void main(String[] args) {
		int n = 128; // number of coins to flip per trial

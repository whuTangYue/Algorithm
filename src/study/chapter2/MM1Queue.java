...
//import study.chapter1.Histogram;
 ...
 *
 * Simulate an M/M/1 queue where arrivals and departures are Poisson processes
 ...
 *
 *
 * Remarks ------- - We assume the interrarrival and service times are
 * independent.
 * 
 *
 ******************************************************************************/
...
public class MM1Queue {
	...
	public static void main(String[] args) {
		double lambda = 0.20; // arrival rate
		double mu = 0.30; // service rate
		...
		double expectedWait = 1 / (mu - lambda); // W = expected
													// time in
													// system
		...
		System.out
				.println("average wait time:" + totalWait / customersServiced);

...
public class LinearProgramming {
	...
	/**
	 * Determines an optimal solution to the linear program { max cx : Ax &le; b, x
	 * &ge; 0 }, where A is a m-by-n matrix, b is an m-length vector, and c is an
	 * n-length vector.
	 *
	 * @param A
	...
	// degenerate - cycles if you choose most positive objective function
	// coefficient

...
import study.chapter2.IndexMaxPQ;
import study.chapter4.Edge;
import study.chapter4.EdgeWeightedGraph;
 ...
 * <p>
 * This is an implementation of <em>Stoer¨CWagner's algorithm</em> using an index
...
public class GlobalMincut {
     ...
     */
    private void makeCut(int t, QuickUnionPathCompressionUF uf) {
    ...
    public static void main(String[] args) {
        ...
        for (int v = 0; v < G.V(); v++) {
            if (mc.cut(v)) System.out.print(v + " ");
        }
        System.out.println();

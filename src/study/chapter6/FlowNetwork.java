...
public class FlowNetwork {
	 ...
	 * edges. The capacities are integers between 0 and 99 and the flow values are
	 * zero.
	 * 
	 * @param V
	 *            the number of vertices
	...
	/**
	 * Initializes a flow network from an input stream. The format is the number of
	 * vertices <em>V</em>, followed by the number of edges <em>E</em>, followed by
	 * <em>E</em> pairs of vertices and edge capacities, with each entry separated
	 * by whitespace.
	 * 
	 * @param in
	 *            the input stream
	...
	public static void main(String[] args) {
		In in = new In("src/data/tinyFN.txt");

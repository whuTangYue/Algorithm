 ...
 * equivalent to reducing to the maximum-flow problem and running the
 * augmenting-path algorithm on the resulting flow network, but it does so with
 * less overhead. The order of growth of the running time in the worst case is
 ...
 * <p>
 * See also {@link HopcroftKarp}, which solves the problem in O(<em>E</em>
 * sqrt(<em>V</em>)) using the Hopcroft-Karp algorithm and <a href =
